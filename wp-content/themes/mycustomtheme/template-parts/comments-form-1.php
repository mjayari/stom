<?php
    ...
    $fields =  array(
        ...
        //Author field
        'author' =>
          '<p class="comment-form-author"><div class="form-group"><label for="author">' . __( $comment_author, 'domainreference' ) . '</label> ' .
        ...
        //Email Field
        'email' =>
          '<p class="comment-form-email"><div class="form-group"><label for="email">' . __( $comment_email, 'domainreference' ) . '</label> ' .
          ( $req ? '<span class="required">*</span>' : '' ) .
